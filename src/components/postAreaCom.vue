...
<!-- 收件人地址 -->
      ...
      <div class="divClass" title="小于100kg噢">
          <b>重量：</b>
         <van-stepper class="weightClass" input-width="45px" max="100" v-model="value1" theme="round" button-size="22"/>
...
data() {
  ...
  submitMsa(){
      ...
      var index = id - 5>=0? id-5 :0;//记录插入了几条数据,
